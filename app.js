...
const translations = {
  en: {
    ...
    downloadNow:'Download on Google Play',watchTrailer:'Watch trailer',statOffline:'Offline',statOfflineSub:'play anywhere',statRooms:'Handcrafted',statRoomsSub:'puzzle rooms',statControls:'3 Controls',statControlsSub:'choose your layout',
    ...
    trailerEyebrow:'Game trailer',trailerTitle:'See the echo mechanic in motion.',trailerText:'Watch how your route becomes a delayed echo that can help solve a room — or become the obstacle.',playTrailer:'Play trailer',downloadEyebrow:'Available now',downloadTitle:'Download Echo Gate on Google Play.',downloadText:'Start solving handcrafted echo puzzles today. Offline gameplay, multiple control layouts, stars, rewards, skills, and unlockable progression.',developer:'Developer',rights:'All rights reserved.'
  },
  ar: {
    ...
    downloadNow:'حمّلها من Google Play',watchTrailer:'شاهد العرض',statOffline:'أوفلاين',statOfflineSub:'العب في أي مكان',statRooms:'مصممة يدويًا',statRoomsSub:'غرف ألغاز',statControls:'3 تحكمات',statControlsSub:'اختر تخطيطك',
...
const videoShell = document.querySelector('[data-video]');
const loadVideo = document.querySelector('[data-load-video]');
loadVideo.addEventListener('click',()=>{
  const iframe = document.createElement('iframe');
  iframe.src = `https://www.youtube-nocookie.com/embed/${VIDEO_ID}?autoplay=1&rel=0`;
  iframe.title = 'Echo Gate game trailer';
